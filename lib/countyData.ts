...
export const counties: CountyData[] = [
  {
    ...
    aquifer: 'Jasper Aquifer (Gulf Coast system)',
    ...
    intro:
      'Montgomery County is home base. B-E Waterwell Services has operated out of Magnolia since 1979, and more of our work happens in this county than anywhere else. Wells here typically reach the Jasper Aquifer between 180 and 320 feet, though the northern and western reaches of the county can run deeper.',
    notes: [
      'Our shop is in Magnolia, so response times across the county are the fastest we offer.',
      'Jasper Aquifer water in this county is generally good quality but carries enough iron to be worth planning for at installation.',
  ...
  },
  {
    ...
    aquifer: 'Chicot and Evangeline Aquifers',
    ...
    intro:
      'Harris County covers more ground and more geological variation than anywhere else we work. Northwest Harris around Tomball and Cypress reaches the Chicot and Jasper at 180 to 360 feet. East Harris — Humble, Kingwood, and the Lake Houston corridor — commonly needs the deeper Evangeline at 240 to 440 feet.',
    notes: [
  ...
  },
  {
    ...
    aquifer: 'Jasper and Sparta Aquifers',
    ...
    notes: [
      'Formation changes across the county, so target depth is assessed per site rather than assumed.',
  ...
  },
  {
    ...
    aquifer: 'Sparta and Queen City Aquifers',
    ...
    intro:
      'Washington County is ranch and homestead country around Brenham and Chappell Hill. The aquifer picture differs from the Houston side of our service area — Sparta and Queen City formations rather than the Gulf Coast system — which changes both target depth and water chemistry.',
    notes: [
      'Different aquifer system than Montgomery and Harris counties, so depth expectations do not transfer.',
      'Estate and acreage properties often need distribution planning beyond the wellhead itself.',
      'Water chemistry here differs from the Jasper Aquifer — worth testing at installation.',
    ],
  },
  {
  ...
  },
  {
    ...
    aquifer: 'Sparta, Queen City, and Carrizo Aquifers',
    depthRange: '250–500 ft',
    ...
    intro:
      'We serve the southern end of Brazos County, including Millican and the surrounding rural acreage. The aquifer system here belongs to the Brazos Valley rather than the Gulf Coast, and target depths reflect that.',
    notes: [
      'Multiple aquifer options depending on depth and required yield.',
  ...
  },
  {
    ...
    notes: [
      ...
      'Same aquifer system and permitting district as neighboring Brazos County.',
    ],
  },
];
