      ...
      <div className={`container ${styles.footerGrid}`}>
        ...
        <div>
          ...
          <ul className={styles.footerLinks}>
            <li><Link href="/water-well-drilling">Water Well Drilling</Link></li>
            <li><Link href="/pump-installation">Pump Installation & Repair</Link></li>
            <li><Link href="/well-rehabilitation">Well Rehabilitation</Link></li>
            <li><Link href="/irrigation-wells">Irrigation Wells</Link></li>
            <li><Link href="/well-inspection">Well Inspection</Link></li>
            <li><Link href="/generator-prep">Generator Prep Kits</Link></li>
          </ul>
        </div>
