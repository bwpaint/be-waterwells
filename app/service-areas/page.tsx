...
export default function ServiceAreasPage() {
  return (
    <>
      ...
      {/* ── FINAL CTA ────────────────────────── */}
      {/* "Don't See Your City?" now leads the footer block, matching the CTA
          placement on every other page; the stats row follows it below. */}
      ...
      {/* ── STATS (moved below the CTA, into the footer band) ── */}
